...
class BoyashJarayonLog(models.Model):
    """Bo'yash jarayoni log — umumiy nechta vishilka bo'yalganini yozadi."""
    ...
    def boyalgan_par(self):
        """Jami bo'yalgan par: vishilka_soni × par_soni."""
        return self.vishilka_soni * self.par_soni
